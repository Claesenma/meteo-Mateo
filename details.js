...
function show_data(data, eenheid) {
  ...
  for (i = 0; i < 24; i++) {
    ...
    if (eenheid=="F") {
      var string2 = (Math.round(((data2.hours[i].temp * 1.8) + 32) * 10) / 10) + "°F";
      var string3 = (Math.round(((data2.hours[i].feelslike * 1.8) + 32) * 10) / 10) + "°F";
    }
  ...
  for (k = 0; k < 4; k++) {
    ...
    home_btn[k].href = "index.html?stad="+data.address+"&taal="+taal+"&eenheid="+window.eenheid;
...
function langue(langueOn,langueOff1,langueOff2,langueOff3){
    ...
    for (k = 0; k < 4; k++) {
      ...
      home_btn[k].href = "index.html?stad="+data.address+"&taal="+taal2+"&eenheid="+window.eenheid;
    }
}
