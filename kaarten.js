...
function show_day_data(day_num) {
  ...
  if (window.eenheid=="F") {
    var temp1 = (Math.round(((data1.days[day_num].tempmax*1.8)+32) * 10) / 10) + "°F"
    var temp2 = (Math.round(((data2.days[day_num].tempmax*1.8)+32) * 10) / 10) + "°F"
    var temp3 = (Math.round(((data3.days[day_num].tempmax*1.8)+32) * 10) / 10) + "°F"
    var temp4 = (Math.round(((data4.days[day_num].tempmax*1.8)+32) * 10) / 10) + "°F"
    var temp5 = (Math.round(((data5.days[day_num].tempmax*1.8)+32) * 10) / 10) + "°F"
  }
...
function langue(langueOn,langueOff1,langueOff2,langueOff3){
    ...
    var home_btn = document.querySelectorAll("#home-btn1");
    ...
    for (k = 0; k < 4; k++) {
      ...
      home_btn[k].href = "index.html?taal="+taal2+"&eenheid="+window.eenheid;
    }
